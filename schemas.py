...
class Lead(BaseModel):
    ...
    subject: Optional[str] = Field(None, max_length=150, description="Sujet")
    message: str = Field(..., min_length=5, max_length=2000, description="Message")
    source: Optional[str] = Field("website", description="Source du lead")
